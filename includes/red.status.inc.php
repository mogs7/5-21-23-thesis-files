...
if (isset($_POST["Reviewed"])) {
    ...
    redreviewed($conn, $id, $licenseNum, $status, $badgeID, $lastName, $firstName, $middleName, $birthday, $licensePlate, $regNum, $date_time);
...
if (isset($_POST["Unaddressed"])) {
    ...
    redunaddressed($conn, $id, $status, $badgeID, $licensePlate, $date_time,);
    header("Location: ../redlight.php?error=none");
}
